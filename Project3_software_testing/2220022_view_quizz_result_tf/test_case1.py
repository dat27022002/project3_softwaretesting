...
def view_quiz_result(self):
  ...
  # In 'Attemps that are: just leave 'Never Submitted' unchecked, the rest are checked - Begin
  attemps_id = ['id_stateinprogress', 'id_stateoverdue', 'id_statefinished', 'id_stateabandoned']
  for attemp in attemps_id:
    if attemp == 'id_stateabandoned':
  ...
  print('{:78s}{:5s}{:4s}'.format("6.  In 'Attemps that are:' leave 'Never Submitted' unchecked, the rest checked","  -  ","Done"))
  # In 'Attemps that are: just leave 'Never Submitted' unchecked, the rest are checked - End
...
class MoodleTest(unittest.TestCase):
  ...
  def test_VIEW_QUIZ_RESULT_1(self):
    print('\n')
    print('----------------------------------------------------------------------------------------------------------------------')
    ...
    5.  Click 'Results'
    6.  In 'Attemps that are: just leave 'Never Submitted' unchecked, the rest are checked
