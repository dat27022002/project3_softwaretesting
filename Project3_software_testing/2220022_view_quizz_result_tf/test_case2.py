...
def view_quiz_result(self):
  ...
  # In 'Attemps that are: Check all choices - Begin
  ...
  print('{:78s}{:5s}{:4s}'.format("6.  In 'Attemps that are: Check all choices","  -  ","Done"))
  # In 'Attemps that are: Check all choices - End
...
class MoodleTest(unittest.TestCase):
  ...
  def test_VIEW_QUIZ_RESULT_2(self):
    print('\n')
    print('----------------------------------------------------------------------------------------------------------------------')
    ...
    5.  Click 'Results'
    6.  In 'Attemps that are: Check all choices
