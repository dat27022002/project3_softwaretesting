...
def view_quiz_result(self):
  ...
  print('{:78s}{:5s}{:4s}'.format("6.  In 'Attemps that are: just leave 'Finished' unchecked, the rest are checked","  -  ","Done"))
  # In 'Attemps that are: just leave 'Finished' unchecked, the rest are checked - End
...
class MoodleTest(unittest.TestCase):
  ...
  def test_VIEW_QUIZ_RESULT_3(self):
    print('\n')
    print('----------------------------------------------------------------------------------------------------------------------')
    ...
    5.  Click 'Results'
    6.  In 'Attemps that are: just leave 'Finished' unchecked, the rest are checked
