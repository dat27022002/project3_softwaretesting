...
class Test_grading(unittest.TestCase):
    ...
    def test_edit_grade(self):
        ...
        time.sleep(2)
        day = driver.find_element(By.LINK_TEXT, "Next 6 months")
        time.sleep(2)
        day.click()
        ...
        try:
            ...
            WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.CLASS_NAME, "timeline-event-list-item"))
            )
            print("Class is present, sorting success")
        except:
            print("Class is not present, sorting failed")
